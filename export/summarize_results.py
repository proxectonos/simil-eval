...
def summarize_similarity_from_path(output_dir, max_col_width=50):
    """
    ...
    for f in os.listdir(output_dir):
        if not (f.startswith("results_") and f.endswith(".xlsx")) or "surprisal" in f:
            continue
        lang = f[8:-5]
    ...
    export_lang_dict_to_excel(summed_dfs_dict, f"{output_dir}/similarity_summary.xlsx", max_col_width=max_col_width)
